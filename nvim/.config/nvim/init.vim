...
nnoremap <leader>f< :Telescope lsp_incoming_calls<CR>
nnoremap <leader>f> :Telescope lsp_outgoing_calls<CR>
nnoremap <leader>f$ :Telescope lsp_document_symbols<CR>
nnoremap <leader>f^ :Telescope lsp_workspace_symbols<CR>
...
nnoremap <leader>fv :Telescope treesitter<CR>
nnoremap <leader>fc :Telescope git_commits<CR>
nnoremap <leader>fT :Telescope git_branches<CR>
nnoremap <leader>fs :Telescope git_status<CR>
nnoremap <leader>fS :Telescope git_stash<CR>
nnoremap <leader>fB :Telescope git_bcommits<CR>
