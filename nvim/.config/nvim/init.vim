...
nnoremap <leader>f% :Telescope oldfiles<CR>
...
nnoremap <leader>c/i :Telescope lsp_incoming_calls<CR>
nnoremap <leader>c/o :Telescope lsp_outgoing_calls<CR>
nnoremap <leader>c/b :Telescope lsp_document_symbols<CR>
nnoremap <leader>c/w :Telescope lsp_workspace_symbols<CR>
nnoremap <leader>c/d :Telescope lsp_definitions<CR>
nnoremap <leader>c/D :Telescope lsp_implementations<CR>
nnoremap <leader>c/T :Telescope lsp_type_definitions<CR>
nnoremap <leader>c/t :Telescope treesitter<CR>
nnoremap <leader>gc :Telescope git_commits<CR>
nnoremap <leader>gb :Telescope git_branches<CR>
nnoremap <leader>gs :Telescope git_status<CR>
nnoremap <leader>gh :Telescope git_stash<CR>
