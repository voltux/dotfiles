...
vim.api.nvim_set_keymap("n", "<leader>sa", "<cmd>ToggleTerm direction=vertical size=120<cr>",
    { silent = true, noremap = true, desc = 'Toggle vertical terminal' })
vim.api.nvim_set_keymap("n", "<leader>sd", "<cmd>ToggleTerm direction=horizontal size=40<cr>",
    { silent = true, noremap = true, desc = 'Toggle vertical terminal' })
