...
setkm("n", "<leader>dn", "<cmd>DashboardNewFile<cr>", { silent = true, noremap = true, desc = 'Dashboard new file' })
setkm("n", "<leader>dl", "<cmd>SessionLoad<cr>", { silent = true, noremap = true, desc = 'Dashboard load session' })
setkm("n", "<leader>ds", "<cmd>SessionSave<cr>", { silent = true, noremap = true, desc = 'Dashboard save session' })
